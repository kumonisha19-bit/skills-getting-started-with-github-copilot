...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the soccer team for practices, drills, and matches",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim laps, improve technique, and compete in friendly races",
    ...
    "Robotics Workshop": {
        "description": "Design, build, and program robots for project challenges",
        "schedule": "Mondays, 4:00 PM - 5:30 PM",
        "max_participants": 14,
        "participants": ["amelia@mergington.edu", "mason@mergington.edu"]
    },
    "Literature Circle": {
        "description": "Read and discuss books, poetry, and creative writing",
